        ...
        <div>
            <nav className = "navbar">
                ...
                <div className = "navbarInfo">
                    <NavLink to = "/" className={({ isActive }) => isActive ? 'activeLink' : 'inactiveLink'}><p>Inicio</p></NavLink>
                    <NavLink to = "../pages/Store" className={({ isActive }) => isActive ? 'activeLink' : 'inactiveLink'}><p>Tienda</p></NavLink>
