                                    ...
                                    <div className='pt-2'>
                                        ...
                                        <div className='row  formularioUser pt-5'>
                                                    ...
                                                    <div className='col-12 user-form'>
                                                        <span className="p-float-label">
                                                            <Calendar id="icon" value={date1} onChange={(e) => setDate1(e.value)}  />
                                                    ...
                                                    <div className='col-4 user-form'>
                                                    <span className="p-float-label">
                                                        <InputText className="jjj" id="lastname" value={value4} onChange={(e) => setValue4(e.target.value)} disabled />
                                                        <label htmlFor="lastname">Numero Celular</label>
                                                    </span>
                                                    </div>
                                                    <div className='col-4 user-form'>
                                                        <span className="p-float-label">
                                                            <InputText className="jjj" id="lastname" value={value5} onChange={(e) => setValue5(e.target.value)} disabled />
                                                            <label htmlFor="lastname">Pais</label>
                                                        </span>
                                                    </div>
                                                    <div className='col-4 user-form'>
                                                        <span className="p-float-label">
                                                            <InputText className="jjj" id="lastname" value={value6} onChange={(e) => setValue6(e.target.value)} disabled />
                                                            <label htmlFor="lastname">Departamento</label>
                                                        </span>
                                                    </div>
                                                    <div className='col-12 user-form'>
                                                        <span className="p-float-label">
                                                            <InputText className="jjj" id="lastname" value={value7} onChange={(e) => setValue7(e.target.value)} disabled />
                                                ...
                                                <NavLink to={"/UserResetPassword"} className="navlink-style">
                                                     <Button label="Cambiar Contraseña" icon="pi pi-shield" />
