...
export class ProductService {
  ...
  getProductsStore() {
    return axios
      .get(`${baseProductURL}/products-store`)
      .then((res) => res.data);
  }
  getVehiclesOfProductById(idProduct) {
    return axios
      .get(`${baseProductURL}/find-vehicles-of-a-product/${idProduct}`)
      .then((res) => res.data);
  }

  getImageOfProduct(idProduct) {
    return axios
      .get(`${baseImageProductURL}/find-by-idProduct/${idProduct}`)
      .then((res) => res.data);
  }
  getProduct(idProduct) {
    return axios.get(`${baseProductURL}/${idProduct}`).then((res) => res.data);
  }
  getImages() {
  ...
  getVehiclesWhereProduct(idProduct) {
    return axios
      .get(`${baseVehicleURL}/get-vehicles-where-product/${idProduct}`)
      .then((res) => res.data);
  }
}
